...
function love.draw()
    ...
    love.graphics.setFont(nFont)
    if gamestate == 'play' then
      love.graphics.print(playername .. "'s Score ",VIRTUAL_WIDTH/2 + 1,5)
    else 
      love.graphics.setFont(nFont)
      love.graphics.print("Enter your name to start")
      love.graphics.setFont(n2Font)
      love.graphics.print(playername,VIRTUAL_WIDTH/2 + 1,VIRTUAL_HEIGHT/2 - 20)
    end
    Player1:render()
    Player2:render()
    ball:render()
